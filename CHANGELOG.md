...
- Pin GitHub Actions to immutable commit hashes, restrict write access to the release job, validate tag/version consistency, and test both optional native helpers.
